...
user in an INI file next to PotPlayerPortable.exe called PotPlayerPortable.ini.
...
copy AppNamePortable.ini from this directory to PotPlayerPortable.ini next to
PotPlayerPortable.exe. The options in the INI file are as follows:
